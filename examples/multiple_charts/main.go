...
func main() {
	...
	logo := core.WrapLogoAsHTML(core.LoadImageBase64("assets/logo.png"), core.AlignCenter)
	footerHeaderBase64 := core.LoadImageBase64("assets/header_footer.png")
	...
	charts := []models.Chart{
		{
			...
			Tag:         core.WrapChartAsHTML(common.GenerateChartBase64(), core.AlignLeft),
			Order:       1,
		},
		{
			Title:       "Page Views",
	...
	report := models.Report{
		Header: models.Header{
			...
			Logo:        logo,
			LogoAlign:   string(core.AlignCenter),
		},
